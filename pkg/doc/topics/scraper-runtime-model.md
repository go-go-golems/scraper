...
- [pkg/sites/submitverbs/host.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/sites/submitverbs/host.go)
- [pkg/sites/submitverbs/runtime.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/sites/submitverbs/runtime.go)
...
- read dependency results with `ctx.dep(...)`
- emit child ops with `ctx.emit(...)`
- write records and artifacts
- use `require("site-db")` and `require("scraper-db")`

The execution path is implemented in:

- [pkg/engine/runner/js.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/engine/runner/js.go)
- [pkg/js/runtime/executor.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/js/runtime/executor.go)
- [pkg/js/runtime/databases.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/js/runtime/databases.go)
...
- [pkg/cmd/worker.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/cmd/worker.go)
- [pkg/engine/scheduler/scheduler.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/engine/scheduler/scheduler.go)
- [pkg/engine/runner/http.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/engine/runner/http.go)
- [pkg/engine/store/sqlite/store.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/engine/store/sqlite/store.go)
...
For example, the NEREVAL fixture workflow now looks like this:
...
3. [pkg/sites/submitverbs/host.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/sites/submitverbs/host.go)
4. [pkg/sites/submitverbs/runtime.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/sites/submitverbs/runtime.go)
5. [pkg/cmd/worker.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/cmd/worker.go)
6. [pkg/engine/scheduler/scheduler.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/engine/scheduler/scheduler.go)
7. [pkg/engine/store/sqlite/store.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/engine/store/sqlite/store.go)
...
| A site writes nothing to its DB | The worker never opened that site DB or the script returned an error early | Start with the command-path tests in [pkg/cmd/site_test.go](/home/manuel/workspaces/2026-03-23/js-scraper/scraper/pkg/cmd/site_test.go) |
...
- [scraper-architecture-overview](scraper help scraper-architecture-overview) — Broader system map and command overview
- [scraper-queue-policies-and-rate-limiting](scraper help scraper-queue-policies-and-rate-limiting) — Queue policy and token-bucket behavior in the worker
- [scraper-new-developer-onboarding](scraper help scraper-new-developer-onboarding) — First-day path through the repo and smoke tests
