...
- [x] Inventory packages commands schemas and executable surfaces <!-- t:c3mc -->
- [x] Map imports runtime control flow and persistence ownership <!-- t:woxq -->
- [x] Audit tests examples documentation CI and scripts for active references <!-- t:17cs -->
- [x] Classify canonical paths that must be retained <!-- t:chzm -->
