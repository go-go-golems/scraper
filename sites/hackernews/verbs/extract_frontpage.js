doc(`Submit a direct Hacker News frontpage fetch plus extract workflow.
...
__verb__("extractFrontpage", {
  ...
  short: "Submit the Hacker News extract_frontpage.js workflow",
  fields: {
    "base-url": {
      type: "string",
...
function extractFrontpage(ctx) {
  ...
  ctx.setWorkflowName("hackernews extract workflow");
  ctx.emit({
    id: fetchID,
    kind: "http/fetch",
